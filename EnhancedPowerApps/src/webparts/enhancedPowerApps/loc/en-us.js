define([], function() {
  return {
    ...
    StaticPropertiesGroupLabel: "Static Properties",
    StaticPropertiesGroupDescription: "You can pass static properties to PowerApps.<br/>Within Power Apps, you can use <pre style='display:inline;font-weight:700;'>Param('{0}')</pre> to retrieve the value.",
    StaticPropertyNameFieldLabel: "Property name",
    StaticPropertyValueLabel: "Property value",
    UseStaticPropsFieldLabel: "Pass static property as paramter?"
  }
});
