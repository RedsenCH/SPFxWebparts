...
export default class TableOfContentsWebPart extends BaseClientSideWebPart<ITableOfContentsWebPartProps> {
    ...
    public render(): void {
        const element: React.ReactElement<ITableOfContentsProps> =
            React.createElement(TableOfContents, {
                ...
                floatingMenuButtonIconColor:
                    this.properties.floatingMenuButtonIconColor,
                floatingMenuButtonBackgroundColor:
                    this.properties.floatingMenuButtonBackgroundColor,
                floatingMenuLabel: this.properties.floatingMenuLabel,
                floatingMenuLinksColor:
                    this.properties.floatingMenuLinksColor ||
                    this._themeVariant?.palette?.black ||
                    "#000000",
                floatingMenuBackgroundColor:
                    this.properties.floatingMenuBackgroundColor ||
                    this._themeVariant?.palette?.themeLighterAlt ||
                    "#ffffff",
                floatingMenuLinkTextDecoration:
                    this.properties.floatingMenuLinkTextDecoration || "none",
                floatingMenuLinkIcon: this.properties.floatingMenuLinkIcon,
                floatingMenuBorderColor:
                    this.properties.floatingMenuBorderColor ||
                    this._themeVariant?.palette?.black ||
                    "#000",
    ...
    protected getPropertyPaneConfiguration(): IPropertyPaneConfiguration {
        const floatingMenu = PropertyPaneToggle("floatingMenu", {
            label: strings.MenuType,
            onText: strings.MenuTypeFloating,
            offText: strings.MenuTypeStandard,
        });

        const floatingMenuButtonIcon = PropertyFieldIconPicker(
            "floatingMenuButtonIcon",
            {
                currentIcon: this.properties.floatingMenuButtonIcon
                    ? this.properties.floatingMenuButtonIcon
                    : "BulletedList2",
                key: "iconPickerId",
                onSave: (icon: string) => {
                    this.properties.floatingMenuButtonIcon = icon;
                },
        ...
        const floatingMenuButtonIconColor = PropertyFieldColorPicker(
            "floatingMenuButtonIconColor",
            {
                key: "floatingMenuButtonIconColor",
                label: strings.floatingMenuButtonIconColor,
                selectedColor: this.properties.floatingMenuButtonIconColor
                    ? this.properties.floatingMenuButtonIconColor
                    : this._themeVariant?.palette?.white,
                onPropertyChange: this.onPropertyPaneFieldChanged.bind(this),
                properties: this.properties,
        ...
        const floatingMenuButtonBackgroundColor = PropertyFieldColorPicker(
            "floatingMenuButtonBackgroundColor",
            {
                key: "floatingMenuButtonBackgroundColor",
                label: strings.floatingMenuButtonBackgroundColor,
                selectedColor: this.properties.floatingMenuButtonBackgroundColor
                    ? this.properties.floatingMenuButtonBackgroundColor
                    : this._themeVariant?.palette?.themePrimary,
                onPropertyChange: this.onPropertyPaneFieldChanged.bind(this),
                properties: this.properties,
                alphaSliderHidden: false,
                style: PropertyFieldColorPickerStyle.Inline,
        ...
        const floatingMenuBackgroundColor = PropertyFieldColorPicker(
            "floatingMenuBackgroundColor",
            {
                key: "floatingMenuBackgroundColor",
                label: strings.floatingMenuBackgroundColor,
                selectedColor: this.properties.floatingMenuBackgroundColor
                    ? this.properties.floatingMenuBackgroundColor
                    : this._themeVariant?.palette?.themeLighterAlt,
                onPropertyChange: this.onPropertyPaneFieldChanged.bind(this),
                properties: this.properties,
        ...
        const floatingMenuLinksColor = PropertyFieldColorPicker(
            "floatingMenuLinksColor",
            {
                key: "floatingMenuLinksColor",
                label: strings.floatingMenuLinksColor,
                selectedColor: this.properties.floatingMenuLinksColor
                    ? this.properties.floatingMenuLinksColor
                    : this._themeVariant?.palette?.black,
                onPropertyChange: this.onPropertyPaneFieldChanged.bind(this),
                properties: this.properties,
        ...
        const floatingMenuLinkIcon = PropertyFieldIconPicker(
            "floatingMenuLinkIcon",
            {
                key: "floatingMenuLinkIcon",
                label: strings.floatingMenuLinkIcon,
                currentIcon: this.properties.floatingMenuLinkIcon,
                onPropertyChange: this.onPropertyPaneFieldChanged.bind(this),
                properties: this.properties,
                onSave: (icon: string) => {
                    this.properties.floatingMenuLinkIcon = icon;
                },
            }
        );

        const floatingMenuLinkTextDecoration = PropertyPaneDropdown(
            "floatingMenuLinkTextDecoration",
            {
                label: strings.floatingMenuLinkTextDecoration,
                options: [
                    {
                        key: "none",
        ...
        const floatingMenuBorderColor = PropertyFieldColorPicker(
            "floatingMenuBorderColor",
            {
                key: "floatingMenuBorderColor",
                label: strings.floatingMenuBorderColor,
                selectedColor: this.properties.floatingMenuBorderColor
                    ? this.properties.floatingMenuBorderColor
                    : this._themeVariant?.palette?.black,
                onPropertyChange: this.onPropertyPaneFieldChanged.bind(this),
                properties: this.properties,
        ...
        if (this.properties.floatingMenu) {
            ...
            displayConfiguration.push(floatingMenuBackgroundColor);
            displayConfiguration.push(floatingMenuLinksColor);
            displayConfiguration.push(floatingMenuLinkIcon);
            displayConfiguration.push(floatingMenuLinkTextDecoration);
            displayConfiguration.push(floatingMenuBorderColor);
        }
                        ...
                        },
                        {
                            ...
                            groupFields: [
                                PropertyFieldCodeEditor("customStyles", {
                                    ...
                                    language:
                                        PropertyFieldCodeEditorLanguages.css,
                                    options: {
                                        wrap: true,
                                        fontSize: 14,
                                        // more options
